...
//        }
        ...
        if indexPath.row == 0
        {
            cell.imageView?.image = UIImage(named: "AppsLOGO_1.png")
        }
        else if indexPath.row == 1
        {
            cell.imageView?.image = UIImage(named: "AppsLOGO_2.png")
        }
        else if indexPath.row == 2
        {
            cell.imageView?.image = UIImage(named: "AppsLOGO_3.png")
        }
        else if indexPath.row == 3
        {
            cell.imageView?.image = UIImage(named: "AppsLOGO_4.png")
        }
