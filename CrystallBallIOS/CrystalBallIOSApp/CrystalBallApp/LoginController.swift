...
class LoginController: UIViewController {
    ...
    {
        // ------------------ GET REQUEST -----------------
        let url = NSURL(string: "http://10.0.1.210:8080/MassOauthServer/rest/oauth/verifyCredentials")
        let sessionConfiguration = URLSessionConfiguration.default
        sessionConfiguration.connectionProxyDictionary = [
            kCFNetworkProxiesHTTPEnable as AnyHashable: true,
            kCFNetworkProxiesHTTPPort as AnyHashable: 8080, //myPortInt
            kCFNetworkProxiesHTTPProxy as AnyHashable: "10.0.1.210"
        ]
        ...
        let task = session.dataTask(with: url! as URL, completionHandler: { (data, response, error) -> Void in
            ...
            if error != nil {
                ...
                do {
                    ...
                    // get string data from web service call
                    //                    var dataString:String = ""
                    //                     dataString = String(describing: NSString(data: data!, encoding: String.Encoding.utf8.rawValue))
                    //                    print("\(dataString)")
