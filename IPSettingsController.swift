...
class IPSettingsController: UIViewController {
    ...
    @IBAction func hostServerIpBtnPressed(_ sender: Any) {
        hostServerIpRadioButtonView?.image = UIImage(named: RADIO_BUTTON_SELECTED_IMAGE)
        checkForUpdatesRadioButtonView?.image = UIImage(named: RADIO_BUTTON_NOT_SELECTED_IMAGE)
        changePwdRadioButtonView?.image = UIImage(named: RADIO_BUTTON_NOT_SELECTED_IMAGE)
    ...
    func showIPAddressAndPortSettings()  {
        ...
        alertController.addTextField(configurationHandler: { (textField) -> Void in
           ...
           // textField.placeholder = self.HOST_SERVER_IP
            textField.text  =  self.HOST_SERVER_IP
        ...
        alertController.addTextField(configurationHandler: { (textField) -> Void in
            ...
            //textField.placeholder = self.HOST_SERVER_PORT
             textField.text  =  self.HOST_SERVER_PORT
            textField.textAlignment = .center
        })
    ...
    @IBAction func checkForUpdatesBtnPressed(_ sender: Any) {
        hostServerIpRadioButtonView?.image = UIImage(named: RADIO_BUTTON_NOT_SELECTED_IMAGE)
        checkForUpdatesRadioButtonView?.image = UIImage(named: RADIO_BUTTON_SELECTED_IMAGE)
        changePwdRadioButtonView?.image = UIImage(named: RADIO_BUTTON_NOT_SELECTED_IMAGE)
    ...
    @IBAction func changePwdBtnPressed(_ sender: Any) {
        hostServerIpRadioButtonView?.image = UIImage(named: RADIO_BUTTON_NOT_SELECTED_IMAGE)
        checkForUpdatesRadioButtonView?.image = UIImage(named: RADIO_BUTTON_NOT_SELECTED_IMAGE)
        changePwdRadioButtonView?.image = UIImage(named: RADIO_BUTTON_SELECTED_IMAGE)
    }
